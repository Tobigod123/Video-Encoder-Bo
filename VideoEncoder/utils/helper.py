...
output = InlineKeyboardMarkup([
    [InlineKeyboardButton("Developer", url="https://github.com/"),
...
start_but = InlineKeyboardMarkup([
    ...
    [InlineKeyboardButton("Developer", url="https://github.com/"), InlineKeyboardButton("Source", url="https://github.com/")]])
