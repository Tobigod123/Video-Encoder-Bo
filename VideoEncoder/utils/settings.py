...
async def OpenSettings(event: Message, user_id: int):
    try:
        await event.edit(
            text="Settings of the Bot<a href='https://telegra.ph//file/a235f7128d526b55a71e0.jpg'>!</a>",
...
async def VideoSettings(event: Message, user_id: int):
    try:
        ...
        await event.edit(
            text="Here's Your Video Settings<a href='https://telegra.ph//file/a235f7128d526b55a71e0.jpg'>:</a>",
            reply_markup=InlineKeyboardMarkup(
                [
...
async def AudioSettings(event: Message, user_id: int):
    try:
        ...
        await event.edit(
            text="Here's Your Audio Settings<a href='https://telegra.ph//file/a235f7128d526b55a71e0.jpg'>:</a>",
            reply_markup=InlineKeyboardMarkup(
                [
